# -*- coding: utf-8 -*-
"""Listas en python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18NPAJI1anXcixO9UOEqLjYGubO9p3lrP
...
def main():
    # Inicializar un arreglo para almacenar las edades
    edades = []
...
def main():
    # Inicializar un arreglo para almacenar los sueldos de los trabajadores
    sueldos = []
